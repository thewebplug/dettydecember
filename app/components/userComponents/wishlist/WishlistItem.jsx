...
import wishlist from "/public/assets/DD/wishlist.jpg";
    ...
    <main className=" border-[1px] border-[#EAEBEA] rounded-lg  ">
      <div className="relative h-[160px]  ">
        <Image
          ...
          objectFit="cover"
        />
        <div className="flex absolute top-[80%] left-5 gap-2 px-4 py-2 items-center border-[1px] border-[#9EE5C4] rounded-full bg-[#EEFCF5]">
