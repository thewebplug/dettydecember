...
export const EventManagementViewModal = ({
  ...
  const [regularTicket, setRegularTicket] = useState(null);
  const [vipTicket, setVipTicket] = useState(null);
  const [platinumTicket, setPlatinumTicket] = useState(null);
  ...
  const handleSetTickets = () => {
    for (let index = 0; index < event?.tickets.length; index++) {
      if (event?.tickets[index]?.ticketType === "regular") {
        setRegularTicket(event?.tickets[index]);
      } else if (event?.tickets[index]?.ticketType === "vip") {
        setVipTicket(event?.tickets[index]);
      } else if (event?.tickets[index]?.ticketType === "platinum") {
        setPlatinumTicket(event?.tickets[index]);
      }
    }
  };
                  ...
                  <div className="user-home__grid__picks__card1__ticket-pocket__card">
                    <div className="user-home__grid__picks__card1__ticket-pocket__card__inner">
                      ...
                      <div>
                        <div>
                          <div className="user-home__grid__picks__card1__ticket-pocket__card__inner__price">
                            #{vipTicket?.ticketPrice}
                          </div>
                          <div className="user-home__grid__picks__card1__ticket-pocket__card__inner__avlb">
                          {vipTicket?.availableTickets} available
                          </div>
                        </div>
                        <svg
                          width="40"
                  ...
                  <div className="user-home__grid__picks__card1__ticket-pocket__card">
                    <div className="user-home__grid__picks__card1__ticket-pocket__card__inner">
                      ...
                      <div>
                        <div>
                          <div className="user-home__grid__picks__card1__ticket-pocket__card__inner__price">
                            #{platinumTicket?.ticketPrice}
                          </div>
                          <div className="user-home__grid__picks__card1__ticket-pocket__card__inner__avlb">
                          {platinumTicket?.availableTickets} available
                          </div>
                        </div>
                        <svg
                          width="40"
