...
export default function Solutions() {
   return (
    ...
    <div className="solutions__hero">
            ...
            <h1 className="solutions__hero__title">
        ...
        <div className="solutions__solve">
            <h2 className="solutions__solve__title">Your problem is ours to solve</h2>
            <h2 className="solutions__solve__subtitle">With access to the best live entertainment tools in the industry to we’ll help you unlock potential like never before.</h2>
        </div>
