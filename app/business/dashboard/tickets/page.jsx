  ...
  return (
    <div className="tickets">
      ...
      <div className="tickets__table">
        <div className="tickets__table__header">
          <div className="tickets__table__header__tickets">
            <div
              className={
                tab === "all" && "tickets__table__header__tickets__active"
              }
              onClick={() => setTab("all")}
            >
              All tickets
            ...
            <div
              className={
                tab === "sold" && "tickets__table__header__tickets__active"
              }
              onClick={() => setTab("sold")}
            >
              Sold
            ...
            <div
              className={
                tab === "refunded" && "tickets__table__header__tickets__active"
              }
            ...
            <div
              className={
                tab === "expired" && "tickets__table__header__tickets__active"
              }
          ...
          <div>
            <form action="" className="tickets__table__header__form">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <div className="tickets__table__header__buttons">
              <button>
                <svg
                  width="20"
                  height="20"
              ...
              {exportMenu && (
                <div className="tickets__table__header__buttons__menu">
        ...
        <div className="tickets__table__body">
          <div className="tickets__table__body__heading">
            <div>Ticket ID</div>
          ...
          <div className="tickets__table__body__inner">
            {[
              {
                id: "395879WD",
                ticket: {
              ...
              <div onClick={() => setSelectedEvent(event)}>
                <div>{event?.id}</div>
                <div className="tickets__table__body__inner__ticket">
                  <div>{event?.ticket?.type}</div>
                  <div>{event?.ticket?.price}</div>
                </div>

                <div className="tickets__table__body__inner__event">
                  <Image
                    width={32}
                    height={32}
                    alt=""
                ...
                <div>{event?.date}</div>
                <div
                  className={`tickets__table__body__inner__status tickets__table__body__inner__status-${event?.status}`}
                >
                  <svg
                    width="6"
                    height="6"
          ...
          <div className="tickets__table__body__footer">
            <button>
              <svg
                width="16"
                height="16"
          ...
          {/* <div className="tickets__table__body__empty">
            <svg
              width="152"
              height="120"
              viewBox="0 0 152 120"
            ...
            <div>
              ...
              Create event to sell your tickets faster.
            </div>
      ...
      {selectedEvent && (
        <div className="tickets__details">
          <div className="tickets__details__title">
            <div>
          ...
          <div className="tickets__details__tabs">
            <div>
              <div
                className={
                  detailsTab === "info" && "tickets__details__tabs__active"
                }
              ...
              <div
                className={
                  detailsTab === "breakdown" && "tickets__details__tabs__active"
                }
          ...
          {detailsTab === "info" && (
            <>
              <div className="tickets__details__info">
                <div>Ticket ID</div>
              ...
              <div className="tickets__details__status">
                <div>Status</div>
                <div
                  className={`tickets__details__status__${selectedEvent?.status}`}
                >
                  {" "}
                  <svg
                    width="6"
         ...
         {detailsTab === "breakdown" && <div className="tickets__details__breakdown">
            <div className="tickets__details__breakdown__header">
              <div>S/N</div>
              <div>Description</div>
              <div>Amount</div>
            </div>
            <div className="tickets__details__breakdown__body">
              <div>1</div>
              <div>
            ...
            <div className="tickets__details__breakdown__footer">
              <div></div>
              <div>Total amount</div>
              <div>₦40,000.00</div>
            </div>
          </div>}
              <div className="tickets__details__close">
                <button
                onClick={() => setSelectedEvent(null)}
                >Close</button>
              </div>
